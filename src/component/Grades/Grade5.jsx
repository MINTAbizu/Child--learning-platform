...
function Grade5() {
 ...
 <div className='d-flex  top'>
      ...
      {studentName && <p className='stusentname'>Welcome, {studentName}!</p>}
      {studentgrade && <p>Your grade is: {studentgrade}</p>}
 </div>
 
<div>
  <div className='sidbar p-2'>
    {/* <Sidbar/> */}
  </div>
  <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="cv-product-box">
                        ...
                        <div class="cv-product-data">
                            <Link to={'/G5math'} class="cv-price-title">Math</Link>
                ...
                <div class="col-lg-3 col-sm-6">
                   <div class="cv-product-box">
                        ...
                        <div class="cv-product-data">
                            <a href="product-single.html" class="cv-price-title">English</a>
                            <p class="cv-pdoduct-price"><>score</> 99%</p>
                ...
                <div class="col-lg-3 col-sm-6">
                   <div class="cv-product-box">
                        ...
                        <div class="cv-product-data">
                            <a href="product-single.html" class="cv-price-title">Sience</a>
                            <p class="cv-pdoduct-price"><>score</> 99%</p>
                ...
                <div class="col-lg-3 col-sm-6">
                   <div class="cv-product-box">
                        ...
                        <div class="cv-product-data">
                            <a href="product-single.html" class="cv-price-title">Biology</a>
                            <p class="cv-pdoduct-price"><>score</> 99%</p>
